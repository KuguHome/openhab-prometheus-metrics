...
public class KuguAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
    ...
    static {
        COUNTER = Counter.build().name(COUNTER_NAME).help("Logback log statements at various log levels")
